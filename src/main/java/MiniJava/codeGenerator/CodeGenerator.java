...
//    }
    ...
    public void call() {
        ...
        varType t = symbolTable.getMethodReturnType(className, methodName).toVarType();
...
//        symbolStack.push(className);
    ...
    private boolean isAssignable(Address a1, Address a2) {
        return a1.varType == a2.varType;
    }
